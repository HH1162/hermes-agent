...
class SessionEntry:
    ...
    # Compression calibration state — persists across agent rebuilds so the
    # compressor doesn't lose its baseline and trigger repeated compaction.
...
class SessionStore:
    ...
    def update_session(
        ...
        last_real_prompt_tokens: Optional[int] = None,
        last_compression_rough_tokens: Optional[int] = None,
        last_rough_tokens_when_real_prompt_fit: Optional[int] = None,
    ) -> None:
