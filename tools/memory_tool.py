...
MEMORY_SCHEMA = {
    ...
    "description": (
        ...
        "Memory is injected into EVERY turn as part of the system prompt.\n\n"
        "ROUTING OPTIONS:\n"
        "- memory.md: rules enforced every turn (keep minimal)\n"
        "- user.md: user profile (keep concise)\n"
        "- mem0_conclude: everything else (has decay, but you can always re-conclude important facts)\n"
        "- skill_manage: reusable procedures and workflows\n"
        "- session_search: task progress and session logs\n\n"
        "CRITICAL: When in doubt, prefer mem0_conclude over memory.md. "
        "It's better to have something searchable than to bloat the system prompt.\n\n"
